  ...
  <div class="position-relative d-flex align-items-center justify-content-center" style="min-height: 400px">
    <div
      ...
      style="
        ...
        left: 0;
        right: 0;
        background-image: url(https://images.unsplash.com/photo-1718013102279-5efc904900ab?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D);
            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
              <div class="card-body py-0">
                <ul class="list-unstyled">
                  <li>
                    <button @click="selectedCategory = ''" class="d-block py-2 border-0 bg-transparent text-muted" type="button">
                      全部
                    </button>
                  </li>
                  <li v-for="category in categories" :key="category">
                    <button @click="selectedCategory = category" class="d-block py-2 border-0 bg-transparent text-muted" type="button">
                      {{ category }}
                    </button>
                  </li>
                </ul>
        ...
        <div class="row">
          <div v-for="product in products" :key="product.id" class="col-md-6">
            <div class="card border-0 mb-4 position-relative position-relative">
              <img style="height: 320px" :src="product.imageUrl" class="card-img-top object-fit-cover rounded-0" alt="琴葉榕" />
              <button type="button" class="position-absolute text-dark border-0 bg-transparent" style="right: 16px; top: 16px">
