...
<template>
  <div class="container">
      ...
      <div class="col-md-7">
        ...
        <div id="carouselExample" class="carousel slide">
          <div class="carousel-container carousel-inner">
            ...
            <div v-for="image in product?.imagesUrl?.filter(Boolean)" :key="image" class="carousel-item">
        ...
        <div class="row align-items-center">
          <div class="col-6">
            <div class="input-group my-3 bg-light rounded">
              ...
              <input type="text" class="form-control border-0 text-center my-auto shadow-none bg-light" readonly :value="productNum" />
              <div class="input-group-append">
                <button @click="productNum++" class="btn btn-outline-dark border-0 py-2" type="button" id="button-addon2">
          ...
          <div class="col-6">
            <button @click="handleAddCartItem" type="button" class="text-nowrap btn btn-dark w-100 py-2">加入購物車</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <template v-if="recommendProducts.length">
      <h3 class="fw-bold">你可能會喜歡的主題</h3>
      <div ref="swiperContainer" class="swiper mt-4 mb-5">
        <div class="swiper-wrapper">
          <div v-for="recommendProduct in recommendProducts" :key="recommendProduct.id" class="swiper-slide">
            <div class="card border-0 mb-4 position-relative position-relative">
              ...
              <div class="card-body p-0">
                <h4 class="mb-0 mt-3">
                  <RouterLink :to="`/products/${recommendProduct.id}`">{{ recommendProduct.title }}</RouterLink>
                </h4>
                <p class="card-text mb-0">
                  NT${{ recommendProduct.price.toLocaleString('zh-TW') }}
                  <span class="text-muted"
                    ><del>NT${{ recommendProduct.origin_price.toLocaleString('zh-TW') }} </del></span
                  >
                </p>
