...
<template>
  <div class="container">
    <Navbar />
    <div v-if="cart?.carts.length === 0" class="min-vh-100 d-flex flex-column justify-content-center align-items-center">
      ...
      <div class="row">
        <div class="col-md-8">
          <table class="table">
            ...
            <tbody>
              <tr v-for="cartItem in cart?.carts" :key="cartItem.id" class="border-bottom border-top">
          ...
          <div class="swiper-wrapper">
            <div v-for="product in products" :key="product.id" class="swiper-slide">
              <div class="card border-0 mb-4 position-relative position-relative">
                <img :src="product.imageUrl" class="card-img-top object-fit-cover rounded-0" style="height: 280px" :alt="product.title" />
